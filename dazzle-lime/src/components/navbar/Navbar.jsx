...
<>
        ...
        <Flex>
        <HStack spacing='55px' className={styless.hsl}>
        <Image className={styless.logo1} src={logo}/>
        <Text  className={styless.hslText} >WOMEN</Text>
        ...
        <HStack spacing='30px' className={styless.hsr} >
        <VStack spacing='1px'>
